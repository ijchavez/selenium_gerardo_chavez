...
public class Ejercicio5 {
    @Test
    public void cssSelectorSpotifyByName(){
        ...
        driver.findElement(By.cssSelector("input[name='confirm']")).sendKeys("test@test.com");
        driver.findElement(By.cssSelector("input[name='password']")).sendKeys("unaContraseña");
        driver.findElement(By.cssSelector("input[name='displayname']")).sendKeys("unNombreDePerfil");

        setBirthdateSpotify(driver,"20","Abril","1955");

        //Intente con //*[@name='gender'][@value='male'] y lo encuentra el inspector, no asi selenium
        //No tiene placeholder ni css selector bueno como para usar
